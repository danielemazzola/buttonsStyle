  ...
  return (
    ...
    <div className="p-5 mt-5">
      ...
      <div className="flex justify-center">
        <button type="button" class="font-bold text-2xl bg-gradient-to-r from-green-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500 text-white px-4 py-3 rounded-lg ease-in-out delay-100 hover:-translate-1 hover:scale-110 duration-300">TailwindCss</button>
      </div>
